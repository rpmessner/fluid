...
defmodule Fluid.CaseTest do
  ...
  test "evaluate variables and expressions" do
    ...
    assert_result "2", "{% case a.size %}{% when 1 %}1{% when 2 %}2{% endcase %}", [a: [1, 1]]
    assert_result "",  "{% case a.size %}{% when 1 %}1{% when 2 %}2{% endcase %}", [a: [1, 1, 1]]
    assert_result "",  "{% case a.size %}{% when 1 %}1{% when 2 %}2{% endcase %}", [a: [1, 1, 1, 1]]
    assert_result "",  "{% case a.size %}{% when 1 %}1{% when 2 %}2{% endcase %}", [a: [1, 1, 1, 1, 1]]
  end

  test "allow assignment from within a {% when %} block" do
    # Example from the shopify forums
    template = "{% case collection.handle %}" <>
  ...
  #   # assert_raise Fluid.SyntaxError fn ->
